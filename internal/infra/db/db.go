...
func Open(ctx context.Context, driver, dsn string) (*gorm.DB, error) {
	...
	if err := db.AutoMigrate(&domain.Connection{}, &domain.ProviderConfig{}, &domain.Combo{}, &domain.ApiKey{}, &domain.UsageEntry{}, &domain.ComboExecution{}, &domain.ModelEntry{}, &domain.Setting{}, &domain.User{}, &domain.Session{}, &domain.UserAccess{}, &domain.MCPClient{}); err != nil {
		_ = Close(db)
